...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Messages.New(context.Background(), greenflashpublicapi.MessageNewParams{
		CreateMessageParams: greenflashpublicapi.CreateMessageParams{
			ExternalUserID: "user-123",
			Messages:       []greenflashpublicapi.MessageItemParam{{}, {}, {}, {}, {}},
		},
	})
	if userAgent != fmt.Sprintf("Greenflash/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Messages.New(context.Background(), greenflashpublicapi.MessageNewParams{
		CreateMessageParams: greenflashpublicapi.CreateMessageParams{
			ExternalUserID: "user-123",
			Messages:       []greenflashpublicapi.MessageItemParam{{}, {}, {}, {}, {}},
		},
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Messages.New(cancelCtx, greenflashpublicapi.MessageNewParams{
		CreateMessageParams: greenflashpublicapi.CreateMessageParams{
			ExternalUserID: "user-123",
			Messages:       []greenflashpublicapi.MessageItemParam{{}, {}, {}, {}, {}},
		},
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Messages.New(deadlineCtx, greenflashpublicapi.MessageNewParams{
			CreateMessageParams: greenflashpublicapi.CreateMessageParams{
				ExternalUserID: "user-123",
				Messages:       []greenflashpublicapi.MessageItemParam{{}, {}, {}, {}, {}},
			},

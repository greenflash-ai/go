...
<a href="https://pkg.go.dev/github.com/stainless-sdks/greenflash-public-api-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/greenflash-public-api-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Greenflash Go library provides convenient access to the [Greenflash REST API](https://docs.greenflash.ai)
...
```go
import (
	"github.com/stainless-sdks/greenflash-public-api-go" // imported as greenflashpublicapi
)
```
...
```sh
go get -u 'github.com/stainless-sdks/greenflash-public-api-go@v0.0.1'
```
...
The greenflashpublicapi library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/greenflash-public-api-go/option).
...
`*greenflashpublicapi.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `greenflashpublicapi.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/greenflash-public-api-go/issues) with questions, bugs, or suggestions.

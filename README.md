...
<a href="https://pkg.go.dev/github.com/greenflash-ai/go"><img src="https://pkg.go.dev/badge/github.com/greenflash-ai/go.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/greenflash-ai/go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/greenflash-ai/go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/greenflash-ai/go/issues) with questions, bugs, or suggestions.
